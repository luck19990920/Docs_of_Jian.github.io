...
2.2版本与2.1版本的区别在于对载入的`gro`文件原子个数取消限制并且在载入与输出`gro`文件时增加了进度条显示。


#### 2.3版本
(以下内容 2025-Nov-1更新)

2.3版本能够读取非标准gro文件并将其输出保存为标准gro文件。标准的gro文件格式可见[gro file format](https://manual.gromacs.org/archive/5.0.3/online/gro.html){:target="_blank"}。gro文件格式可做如下的归纳。
